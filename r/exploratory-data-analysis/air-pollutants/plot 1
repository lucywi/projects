...
## emissions from PM2.5 decreased in the United States from 1999 to 2008.
...
barplot(table(emissions.year$year), col = "blue", main = "Total PM2.5 emissions in the US by 
